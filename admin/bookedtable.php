                        ...
                        <?php 
                            ...
                            <tr>
                              ...
                              <td>
                                    ...
                                    <a  href="deletetable.php?utdid=<?php echo $row['utid']; ?>" ><button class="btn btn-sm btn-danger">Cancel</button></a> 
									<a  href="deletetable.php?utcid=<?php echo $row['utid']; ?>" ><button class="btn btn-sm btn-primary">Visited</button></a>
